        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm rounded-4 p-3 h-100">
                    ...
                    <h3 class="mt-2 mb-0">{{ number_format($summary['active']) }}</h3>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm rounded-4 p-3 h-100">
                    <small class="text-muted">Fixed Charges</small>
                    <h3 class="mt-2 mb-0">{{ number_format($summary['fixed']) }}</h3>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow-sm rounded-4 p-3 h-100">
                    <small class="text-muted">Percentage / Discount</small>
                    <h3 class="mt-2 mb-0">{{ number_format($summary['percentage'] + $summary['discount']) }}</h3>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <form method="GET" action="{{ route('reports.distributor-other-charges') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        @if(request()->filled('charge_id'))
                            <div class="col-lg-2">
                                <a href="{{ route('reports.distributor-other-charges') }}" class="btn btn-outline-secondary btn-lg w-100">
                                    Clear Selection
                                </a>
                            </div>
                        @endif
                    ...
                    <div class="row row-cols-1 row-cols-md-4 g-3 mt-4">
                        <div class="col">
                            <div class="p-3 bg-light rounded-4 h-100">
                                ...
                                <div class="h4 mb-0">{{ number_format($transactionSummary['count']) }}</div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-light rounded-4 h-100">
                                <small class="text-muted">Total Charge Amount</small>
                                <div class="h4 mb-0">PHP {{ number_format($transactionSummary['total_charge'], 2) }}</div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-light rounded-4 h-100">
                                <small class="text-muted">Total Transaction Value</small>
                                <div class="h4 mb-0">PHP {{ number_format($transactionSummary['total_amount'], 2) }}</div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-light rounded-4 h-100">
                                <small class="text-muted">Unique Dealers</small>
                                <div class="h4 mb-0">{{ number_format($transactionSummary['dealers']) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-content rounded-4 border-0 shadow-sm">
                        ...
                        <div class="modal-body">
                            <dl class="row">
                                ...
                                <dd class="col-sm-8" id="detailTransactionId"></dd>
                                ...
                                <dt class="col-sm-4">Charge Amount</dt>
                                <dd class="col-sm-8" id="detailChargeAmount"></dd>

                                <dt class="col-sm-4">Transaction Total</dt>
