...
<style>
    ...
    .product-modal .modal-header { flex: 0 0 auto; padding: 18px 22px; border-bottom: 1px solid #e8edf3; background: linear-gradient(135deg, #fff 0%, #f6faff 100%); }
    ...
    .product-modal .modal-footer { flex: 0 0 auto; padding: 14px 22px; border-top: 1px solid #e8edf3; background: #fff; }
