...
Route::get('/reports/aging-report-customer', 'ReportController@customerAgingReport')->name('aging-report-customer');
...
Route::get('/reports/ad-awarded-areas', 'ReportController@adAwardedAreasReport')->name('ad-awarded-areas');
